...
\fbox{\includegraphics[width=(1.0\linewidth)]{pics/rob-flyer-sm}}\\
To the death!
\end{minipage}
...
\searchcard{ORDER (3)}{Precise location:\\Hermea,\\Hive
  Bahlus.}{Witnesses cite the Magos cowering among the
...
\searchcard{ORDER (1)}{Clue:\\Apollon.}{A planetary defense company
  saw the Magos board a Mechanicum ground transport near Forge
  Praxus.}\hfill%
...
\searchcard{ORDER (3)}{Clue:\\Hermea.}{Shuttle pilots logged delivery
...
\noindent%
\searchcard{ORDER (1)}{Clue:\\Apollon.}{Entry records show the Magos
  recently interfaced with the noosphere from a terminal in Forge
  Maurus.}\hfill%
\searchcard{ORDER (2)}{Clue:\\Apollon.}{Requisitions document that the
  Magos ordered an orbital lifter prepared but it was later damaged.}\hfill%
...
\noindent%
\searchcard{DISCORD (1)}{Precise location:\\Juno,\\House
  Etrakus.}{Entombed in rubble, a single alcove in the buried library
  is lit by shafts of light suspending ancient armor.}\hfill%
\searchcard{DISCORD (2)}{Precise location:\\Juno,\\The Scar.}{Scans
...
\noindent%
\searchcard{DISCORD (1)}{Clue:\\Juno.}{A burnt data chip plays the
...
\noindent%
\searchcard{DISCORD (1)}{Clue:\\Juno.}{Stone lythos predating the
  Imperium from the barren continent depict a colossal warrior astride
  the world.}\hfill%
\searchcard{DISCORD (2)}{Clue:\\Juno.}{Only something massive and
  moving incredibly fast could have dug those gouges out of the
  planet.}\hfill%
...
\searchcard{DISCORD}{No result.}{ Only false beliefs and nonsense spew
